...
# (Some of these components are now manually defined in the script)
# (They may look strange, but they are based on the actual file components)


# Metadata that appears at the beginning of the file
DAT_Metadata <- c("Generated by J.A.Engott\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t",
                  "precip 15\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t",
                  "tmax 8\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t",
                  "tmin 8\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t",
                  "runoff 22\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t",
...
DAT_Headers <- c("Year", "month", "day", "h", "m", "s",
                 "NOAA_PRECIP1", "NOAA_PRECIP2", "NOAA_PRECIP3", "RAWS_PRECIP4", "NOAA_PRECIP5", "CIMIS_PRECIP6",
                 "RAWS_PRECIP7", "NOAA_PRECIP8", "RAWS_PRECIP9", "NOAA_PRECIP10", "NOAA_PRECIP11", "CIMIS_PRECIP12",
                 "NOAA_PRECIP13", "NOAA_PRECIP14", "NOAA_PRECIP15", "NOAA_TMAX1", "NOAA_TMAX2", "CIMIS_TMAX3",
                 "CIMIS_TMAX4", "RAWS_TMAX5", "NOAA_TMAX6", "RAWS_TMAX7", "RAWS_TMAX8", "NOAA_TMIN1",
                 "NOAA_TMIN2", "CIMIS_TMIN3", "CIMIS_TMIN4", "RAWS_TMIN5", "NOAA_TMIN6", "RAWS_TMIN7",
                 "RAWS_TMIN8", "Runoff1", "Runoff2", "Runoff3", "Runoff4", "Runoff5",
                 "Runoff6", "Runoff7", "Runoff8", "Runoff9", "Runoff10", "Runoff11",
                 "Runoff12", "Runoff13", "Runoff14", "Runoff15", "Runoff16", "Runoff17", 
                 "Runoff18", "Runoff19", "Runoff20", "Runoff21", "Runoff22")
